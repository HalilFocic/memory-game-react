...
// Make this again using useReducer and useState
// Make it winable
// Make start game
// Match counter (how many cards has been correctly guessed)
// You win modal displayed after guessing everything
// Maybe count number of moves it took to win
...
class MemoryGame extends Component {
  ...
  handleClick(id) {
    ...
    if (
      ...
      showingCards[0].front === showingCards[1].front
    ) {
    ...
    const cards = this.state.cards.map((card) => {
      return (
        <div key={card.id} className="kartica">
          <ReactCardFlip
            isFlipped={card.cardState !== CardState.hidding}
